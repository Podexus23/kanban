...
const langSrc = JSON.parse(localStorage.getItem("doska_lng")) || "en";
// the translations
...
i18n
  ...
  .init({
    resources,
    lng: langSrc, // language to use, more information here: https://www.i18next.com/overview/configuration-options#languages-namespaces-resources
